...
class MasterCardPayment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        double totalSpacing = 15.0; // ระยะห่างรวม (5.0 * 3 สำหรับ 3 ช่อง)
  ...
  Widget _buildActionButton(String label, Color color, [String? imagePath]) {
    return Expanded(
      child: Container(
              ...
              if (imagePath != null)
                Align(
                  ...
                  child: Image.asset(
                    imagePath,
                    width:
                        24, // ลดขนาดจาก 49 เป็น 24 เพื่อให้เหมาะสมกับความสูงใหม่
                    height:
                        20, // ลดขนาดจาก 41 เป็น 20 เพื่อให้เหมาะสมกับความสูงใหม่
                    fit: BoxFit.contain,
                  ),
                ),
              Text(
