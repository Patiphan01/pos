...
class VoidPayment extends StatelessWidget {
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: GridView.count(
                    ...
                    childAspectRatio: 1.2, // สัดส่วนของปุ่ม
      ...
      child: ElevatedButton(
        ...
        child: label == "⌫"
            ? const Icon(Icons.backspace,
                color: Colors.black, size: 20) // ปรับขนาด Icon ให้เล็กลง
            : Text(
                label,
                style: const TextStyle(
                  fontSize: 18,
